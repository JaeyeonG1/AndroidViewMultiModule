...
internal fun configureFlavors(
    ...
    commonExtension.apply {
        ...
        when (this) {
            is ApplicationExtension -> flavors.forEach {
                it.buildFlavor(this, flavorConfigurationBlock)
            }

            is LibraryExtension -> flavors.forEach {
                it.buildLibraryFlavor(this, flavorConfigurationBlock)
            }
        }
    }
}
